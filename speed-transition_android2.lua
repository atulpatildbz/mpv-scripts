lookahead = 0.75         --if the next subtitle appears after this threshold then speedup
speedup = 4.0           --the value that "speed" is set to during speedup
...
mp.set_property("sub-delay", -0.3)
mp.set_property("speed", 1.9)
